...
#  Created by Genus(TM) Synthesis Solution 21.17-s066_1 on Sun Dec 14 11:45:38 EST 2025
...
set_load -pin_load 4.0 [get_ports Di]
...
set_output_delay -clock [get_clocks clk] -add_delay 0.03 [get_ports Di]
