...
set rtlFiles [list ../RTL/src/alu_32bit_behavioral.v ../RTL/src/alu_1bit.v ../RTL/src/arithmetic_unit.v ../RTL/src/full_adder.v ../RTL/src/logic_unit.v ../RTL/src/mux4to1.v]  ;# List of your Verilog source files
set topModule alu_32bit_modular                        ;# Name of your top-level module (here counter.v)
...
set clockFrequency 1.0                     ;# Clock frequency in MHz
