...
# Generated on: Sun Dec 14 11:45:38 EST 2025 (Sun Dec 14 16:45:38 UTC 2025)
...
set logfile fv/arithmetic_unit/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/arithmetic_unit -revised fv_map
...
read_design  -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -verilog2k ../RTL/src/arithmetic_unit.v ../RTL/src/full_adder.v ../RTL/src/mux4to1.v
elaborate_design -golden -root {arithmetic_unit} -rootonly 

read_design -verilog95   -revised -lastmod -noelab fv/arithmetic_unit/fv_map.v.gz
elaborate_design -revised -root {arithmetic_unit}
...
write_compared_points noneq.compared_points.arithmetic_unit.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.arithmetic_unit.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.arithmetic_unit.rtl.fv_map.rpt
